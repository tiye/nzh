 ...
 * @returns object
 */
export let getNumbResult = function (num) {
 ...
 * @returns array
 */
export let centerArray = function centerArray(
  baseArray,
 ...
 * @returns
 */
export let hasAttr = function (obj, key) {
 ...
 * @returns
 */
export let extend = function (obj) {
  var name,
    target = arguments[0] || {};
 ...
 */
export let getDigit = function (index) {
 ...
 * @param {number} n
 */
export let unshiftZero = function (arr, n) {
  if (n == null) n = 1;
  if (n <= 0) return;
  for (; n--; ) arr.unshift(0);
};
 ...
 * @returns
 */
export let clearZero = function (str, zero, type) {
  if (str == null) return "";
